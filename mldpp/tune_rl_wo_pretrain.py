...
from rl_predictor_wo_pretrain import *

class TunerRLWOPretrain:
    ...
    def __update_mm_config_ml(self, bench_pid, model_name, new_datapoint):
        return self.memmanagement_module.update_ml(self.predictor, bench_pid, model_name, new_datapoint)
    
    def __update_mm_config_rl(self):
        return self.predictor.update_config()
    ...
    def do(self):
        ...
        self.predictor = RLPredictorWOPretrain(self.__model_name(), self.memmanagement, self.collect_period, self.logdir, ldram_size, bench_pid)
        self.__run_and_collect(count, bench_pid, ldram_size)
