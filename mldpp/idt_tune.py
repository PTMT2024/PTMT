...
class IDTTuner:
    ...
    def __update_mm_config_ml(self, bench_pid, model_name, new_datapoint):
        return self.memmanagement_module.update_ml(self.idt_driver, bench_pid, model_name, new_datapoint)
    
    def __update_mm_config_rl(self):
        return self.idt_driver.update_config()
    
    def __reset_rl(self):
        return self.idt_driver.reset()

    def __save_existing_result(self, count, random_config, ldram_size, metrics_result):
        workload_result = {}
    ...
    def __run_and_collect(self, count, bench_pid, ldram_size):
        self.idt_driver.driver(n_iter=16384)
    ...
    def do(self):
        ...
        self.idt_driver = IDTDriver(self.memmanagement, self.collect_period, self.logdir, ldram_size, bench_pid)
        self.__run_and_collect(count, bench_pid, ldram_size)
