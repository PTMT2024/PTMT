...
class OneRandomTuner:
    ...
    def __reset_mm_config_random(self, bench_pid):
        return self.memmanagement_module.reset_random(bench_pid)
    ...
    def __run_and_collect(self, count, bench_pid, ldram_size):
        random_config = self.__reset_mm_config_random(bench_pid) 
