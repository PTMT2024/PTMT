...
class Collector:
    ...
    def __update_mm_config_ml(self, bench_pid, model_path, new_datapoint):
        return self.memmanagement_module.update_ml(bench_pid, model_path, new_datapoint)
    ...
    def __run_and_collect(self, count, bench_pid, ldram_size):
        ...
        if count == 1:
            ...
            random_config = self.__update_mm_config_random(bench_pid)
    ...
    def do(self):
        ...
        # DAMON
        # subprocess.Popen(f'/home/sherry/miniconda3/bin/damo record -o {self.logdir}/damon.data {bench_pid}', shell=True) 

        print("collect_metrics_cmd: ", collect_metrics_cmd)
        sleep(6)
        count = 0
        if self.memmanagement == "mldpp":
            tune_pid = get_pid_of_process("user_space_page_migration")
        while True:
            count += 1
            ...
            if self.memmanagement == "mldpp":
                try:
                    ...
                    print("user_space_page_migration abort")
                    break
