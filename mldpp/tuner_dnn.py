...
class TunerDNN:
    def __init__(self, workload, memmanagement, bench, logdir, collectperiod):
        ...
        self.predictor = DnnPredictor(self.__model_name(), self.memmanagement)
    ...
    def __model_name(self):
        ...
        for suffix in suffixes:
            if workload_name.endswith(suffix):
                ...
                break
        return f"model.{workload_name}.{self.memmanagement}.dnn_model.latency.{self.collect_period}s.pt"
