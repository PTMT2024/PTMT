...
class DefaultTunerWithML:
    def __init__(self, workload, memmanagement, bench, logdir, collectperiod):
        ...
        self.predictor = Predictor(self.__model_name())
    ...
    def __update_mm_config_default_with_ml(self, bench_pid, model_name, new_datapoint):
        return self.memmanagement_module.update_default_with_ml(self.predictor, bench_pid, model_name, new_datapoint)
    ...
    def __run_and_collect(self, count, bench_pid, ldram_size):
        ...
        if count == 1:
            ...
            random_config = self.__update_mm_config_default_with_ml(bench_pid, self.__model_name(), self.previous_status)
