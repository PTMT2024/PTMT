...
class Train:
    ...
    def __init__ (self, need_restore, chkpt, memmanagement, collect_period, logdir, ldram_size, bench_pid, select_env="damon-v0"):
        logging.info("Train initializing.")

        self.rl_config = RL_Config(memmanagement, collect_period, logdir, ldram_size, bench_pid)
