...
while :
do
    cat /proc/vmstat | grep numa_local >> ${TARGET}/numa_local.txt
    cat /proc/vmstat | grep numa_other >> ${TARGET}/numa_other.txt
    cat /proc/vmstat | grep numa_pages_migrated >> ${TARGET}/numa_pages_migrated.txt
    cat /proc/vmstat | grep numa_hint_faults | grep -v "numa_hint_faults_local" >> ${TARGET}/numa_hint_faults.txt
